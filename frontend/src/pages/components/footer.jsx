      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="text-white font-bold text-xl">DolanTix</span>
            </div>
            <p className="text-gray-400 mb-4">Platform tiket event terpercaya di Semarang. Temukan dan beli tiket event dengan mudah dan aman.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white">Jual Tiket Event</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">Event Organizer</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">Sponsorship</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white">Kerjasama</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white">Kontak Kami</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-6">
          <p className="text-gray-400 text-sm text-center">
            © {new Date().getFullYear()} DolanTix. Hak Cipta Dilindungi.
          </p>
        </div>
      </div>
    </footer>
