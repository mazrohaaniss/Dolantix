...
import UserNavbar from "../../components/UserNavbar"; // Menambahkan navbar user
...
const UserDashboard = () => {
  ...
  <div className="flex justify-between items-center mb-6 pb-4 border-b border-gray-200">
    <h2 className="text-2xl font-bold text-gray-800">Daftar Acara Olahraga</h2>
  </div>
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <button
                            ...
                            className={`px-3 py-1 text-xs rounded font-medium ${
                              ticket.stock > 0 ? "bg-green-500 text-white hover:bg-green-600" : "bg-gray-300 text-gray-500 cursor-not-allowed"
                            } transition-colors`}
                          >
